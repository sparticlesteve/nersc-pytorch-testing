...
#SBATCH -t 10
#SBATCH -o slurm-pm-shifter-test-%j.out

# Shifter image ID (shifterimg lookup NAME)
...
# Funny workaround to prevent directory confusion
cd /home/sfarrell/pytorch-testing

srun -u -l shifter --image=id:${SID} --module gpu \
    python test_ddp.py --gpu --backend nccl --init-method slurm \
